 ...
 */
public class PowerVmSelectionPolicyMaximunUDM extends PowerVmSelectionPolicy {
	...
	public Vm getVmToMigrate(PowerHost host) {
		...
		for (Vm vm : migratableVms) {
			...
			double vmUtilization = vm.getTotalUtilizationOfCpuMips(CloudSim.clock()) / vm.getMips();
			double metric = vmUtilization / vmRam;
			if (metric > minMetric) {
				minMetric = metric;
				vmToMigrate = vm;
			}
